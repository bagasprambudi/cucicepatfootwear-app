            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-sm-5">
                        ...
                        <input type="text" name="name" value="{{ $spending->name }}" class="form-control"
                            id="name" required>
                    </div>
                    <div class="form-group col-sm-5">
                        <label for="place">Tempat pengeluaran</label>
                        <input type="text" name="place" value="{{ $spending->place }}" class="form-control"
                            id="place" required>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-5">
                        ...
                        <input type="date" name="spending_date" value="{{ $spending->spending_date }}"
                            class="form-control" id="spending_date">
                    </div>
                    <div class="form-group col-sm-5">
                        <label for="total">Total pengeluaran</label>
                        <input type="number" name="total" value="{{ $spending->total }}" class="form-control"
                            id="total" required>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-5">
                        ...
                        <textarea name="desc" class="form-control" id="desc" cols="30" rows="5"
                            placeholder="Masukkan keterangan pesanan" required>{{ $spending->desc }}</textarea>
                    </div>
                </div>
                <div class="row">
                    <div>
