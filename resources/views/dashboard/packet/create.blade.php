            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-sm-5">
                        ...
                        <input type="text" name="name" class="form-control" id="packetname"
                ...
                <div class="row">
                    <div class="form-group col-sm-5">
                        ...
                        <input type="text" name="code_packet" class="form-control" id="codename"
                            placeholder="Masukkan kode paket" required>
                    </div>
                    <div class="form-group col-sm-5">
